...
public class DrawingHelper {
    ...
    public DrawingHelper(Pane canvas) {
        this.canvas = canvas;
    }
    ...
    public void drawArc(double centerX,double centerY, double radiusX,double radiusY, double startAngle) {
    ...
    public void drawEllipse(double centerX, double centerY, double radiusX, double radiusY) {
